...
class TourViewer extends Component
{
    ...
    public ?string $currentProbeId = null;
    ...
    public ?string $startProbeId = null;
    ...
    public function onTourNavigate(string $fromProbeId, string $toProbeId): void
    {
        $this->currentProbeId = $toProbeId;
    }
    ...
    {
        return view('vizor::livewire.tour-viewer');
    }
}
